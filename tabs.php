...
<ul id="menu">
  <li id="nav-1"><a href="<?php echo $action['home']?>">Home</a></li>
  <?php
  if (user_is_admin($user_id, $db)) {
        echo '
      <li id="nav-2"><a href="'.$action['admin'].'" target="_parent">Admin</a>
        <ul id="subnav-2">';
         if($user_id!='1'){
        ...
        {echo '
        <li id="nav-2"><a href="'.$action['edituser'].'&id='.$user_id.'" target="_parent">My Account</a>
        <ul id="subnav-2">

        </ul>';}
        }
  ?>
  <li id="nav-3"><a href="<?php echo $action['listkeys']?>" target="_parent">Keys</a>
  <li id="nav-4"><a href="<?php echo $action['main']?>"  target="_parent">Project</a>

  </li>
  <li id="nav-5"><a href="<?php echo $action['websparql']?>" target="_parent">SPARQL</a>
  </li>

  <li id="nav-6"><a href="<?php echo $action['logout']?>" target="_parent">Logout</a>
  </li>
</ul>
<!-- END header -->
