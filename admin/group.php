...
<table class="middle">
	...
	<table class="insidecontents" width="60%" align="center">
		<?php 
		if(!empty($groups))
		echo '<tr bgcolor="#99CCFF"><td align="center">'.$manager.'</td></tr>
...
<table class="bottom" width="60%"  align="center">
	...
	<tr><td align="left"><input type="button" name="newgroup" value="New Group Account" onClick="window.location='<?php echo $action['creategroup'] ?>'"><br /><br /></td></tr>
	</table>
	</td></tr>
</form>
</table>
